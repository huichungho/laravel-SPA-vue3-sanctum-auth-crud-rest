...
{
    /**
     * The Project Gutenberg ECustomer of Sklepy cynamonowe, by Bruno Schulz
     *
     * Copyright laws are changing all over the world. Be sure to check the
     * copyright laws for your country before downloading or redistributing
     * this or any other Project Gutenberg eCustomer.
     *
     ...
     * eCustomer and Project Gutenberg at the bottom of this file.  Included is
     ...
     *
     * **eCustomers Readable By Both Humans and By Computers, Since 1971**
     *
     * *****These eCustomers Were Prepared By Thousands of Volunteers!*****
     *
     *
     ...
     * Author: Bruno Schulz
     *
     * Release Date: May, 2005 [ECustomer #8119]
...
EOT;
    ...
    /*
    End of the Project Gutenberg ECustomer of Sklepy cynamonowe, by Bruno Schulz

    *** END OF THE PROJECT GUTENBERG EBOOK SKLEPY CYNAMONOWE ***

    This file should be named sklep10.txt or sklep10.zip
    Corrected EDITIONS of our eCustomers get a new NUMBER, sklep11.txt
    VERSIONS based on separate sources get new LETTER, sklep10a.txt

    Produced by Pawel Sobkowiak - Scanned and proofread by
    Polska Biblioteka Internetowa

    Project Gutenberg eCustomers are often created from several printed
    editions, all of which are confirmed as Public Domain in the US
    unless a copyright notice is included.  Thus, we usually do not
    keep eCustomers in compliance with any particular paper edition.

    We are now trying to release all our eCustomers one year in advance
    ...
    The official release date of all Project Gutenberg eCustomers is at
    ...
    eCustomers, and how to subscribe to our email newsletter (free!).

    Those of you who want to download any eCustomer before announcement
    ...
    ftp://ftp.ibiblio.org/pub/docs/customers/gutenberg/etext03
    ...
    to get any eCustomer selected, entered, proofread, edited, copyright
    searched and analyzed, the copyright letters written, etc.   Our
    projected audience is one hundred million readers.  If the value
    per text is nominally estimated at one dollar then we produce $2
    million dollars per hour in 2002 as we release over 100 new text
    files per month:  1240 more eCustomers in 2001 for a total of 4000+
    We are already on our way to trying for 2000 more eCustomers in 2002
    If they reach just 1-2% of the world's population then the total
    will reach over half a trillion eCustomers given away by year's end.

    The Goal of Project Gutenberg is to Give Away 1 Trillion eCustomers!
    This is ten thousand titles each to one hundred million readers,
    which is only about 4% of the present number of computer users.

    Here is the briefest record of our progress (* means estimated):

    eCustomers Year Month
    ...
    ***START**THE SMALL PRINT!**FOR PUBLIC DOMAIN EBOOKS**START***
    ...
    your copy of this eCustomer, even if you got it for free from
    someone other than us, and even if what's wrong is not our
    fault. So, among other things, this "Small Print!" statement
    disclaims most of our liability to you. It also tells you how
    you may distribute copies of this eCustomer if you want to.

    *BEFORE!* YOU USE OR READ THIS EBOOK
    By using or reading any part of this PROJECT GUTENBERG-tm
    eCustomer, you indicate that you understand, agree to and accept
    this "Small Print!" statement. If you do not, you can receive
    a refund of the money (if any) you paid for this eCustomer by
    sending a request within 30 days of receiving it to the person
    you got it from. If you received this eCustomer on a physical
    medium (such as a disk), you must return it with your request.

    ABOUT PROJECT GUTENBERG-TM EBOOKS
    This PROJECT GUTENBERG-tm eCustomer, like most PROJECT GUTENBERG-tm eCustomers,
    ...
    below, apply if you wish to copy and distribute this eCustomer
    under the "PROJECT GUTENBERG" trademark.

    Please do not use the "PROJECT GUTENBERG" trademark to market
    any commercial products without permission.

    To create these eCustomers, the Project expends considerable
    efforts to identify, transcribe and proofread public domain
    works. Despite these efforts, the Project's eCustomers and any
    medium they may be on may contain "Defects". Among other
    things, Defects may take the form of incomplete, inaccurate or
    corrupt data, transcription errors, a copyright or other
    intellectual property infringement, a defective or damaged
    disk or other eCustomer medium, a computer virus, or computer
    codes that damage or cannot be read by your equipment.

    LIMITED WARRANTY; DISCLAIMER OF DAMAGES
    But for the "Right of Replacement or Refund" described below,
    [1] Michael Hart and the Foundation (and any other party you may
    receive this eCustomer from as a PROJECT GUTENBERG-tm eCustomer) disclaims
    ...
    If you discover a Defect in this eCustomer within 90 days of
    ...
    following that you do or cause:  [1] distribution of this eCustomer,
    [2] alteration, modification, or addition to the eCustomer,
    or [3] any Defect.

    DISTRIBUTION UNDER "PROJECT GUTENBERG-tm"
    You may distribute copies of this eCustomer electronically, or by
    disk, customer or any other medium if you either delete this
    "Small Print!" and all other references to Project Gutenberg,
    or:

    [1]  Only give exact copies of it.  Among other things, this
         requires that you do not remove, alter or modify the
         eCustomer or this "small print!" statement.  You may however,
         if you wish, distribute this eCustomer in machine readable
         binary, compressed, mark-up, or proprietary form,
         including any form resulting from conversion by word
         processing or hypertext software, but only so long as
         *EITHER*:

         [*]  The eCustomer, when displayed, is clearly readable, and
         ...
         [*]  The eCustomer may be readily converted by the reader at
              no expense into plain ASCII, EBCDIC or equivalent
              form by the program that displays the eCustomer (as is
              the case, for instance, with most word processors);
              OR

         [*]  You provide, or agree to also provide on request at
              no additional cost, fee or expense, a copy of the
              eCustomer in its original plain ASCII form (or in EBCDIC
              or other equivalent proprietary form).

    [2]  Honor the eCustomer refund and replacement provisions of this
    ...
    [Portions of this eCustomer's header and trailer may be reprinted only
    when distributed free of all fees.  Copyright (C) 2001, 2002 by
    Michael S. Hart.  Project Gutenberg is a TradeMark and may not be
    used in any sales of Project Gutenberg eCustomers or other materials be
